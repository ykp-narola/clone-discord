				...
				<div className={style.active_now}>
					...
					<div className={style.card}>
						...
						<div className={style.card_content}>
							when friends starts an activity - like playing games or hanging
...
const Tab = ({ tab }) => {
	...
	else if (tab === "block") return <Block />;
	else if (tab === "pending") return <Pending />;
	else if (tab === "friends") return <MyFriends />;
